...
const ComponentNameCustomizationCtrlr component.Name = "CustomizationCtrlr"
...
func (c *CustomizationCtrlr) GetName() component.Name {
	return ComponentNameCustomizationCtrlr
}
